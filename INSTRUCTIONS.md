...
3. Run the project GitHub pages npm build command (this builds and creates docs/[YOUR_APP_NAME] content that GitHub pages will serve from)
4. Commit changes
5. Navigate to `[USERNAME].github.io/[YOUR_WORKSPACE_NAME]/[YOUR_APP_NAME]` (NOTE: It can take a couple of minutes for content to be available)
